...
| -------------- | ------------------------- | --------------------- | 
| `n=2**0`       |        0.258 usec         |         1.26 usec     |
| `n=2**1`       |        0.308 usec         |         1.86 usec     |
| `n=2**2`       |        0.602 usec         |         1.58 usec     |
| `n=2**3`       |         0.69 usec         |         1.66 usec     |
| `n=2**4`       |        0.999 usec         |         1.88 usec     |
| `n=2**5`       |         1.44 usec         |         2.79 usec     |
| `n=2**6`       |            2 usec         |         3.15 usec     |
| `n=2**7`       |         3.39 usec         |         3.51 usec     |
| `n=2**8`       |           11 usec         |         4.47 usec     |
| `n=2**9`       |         15.4 usec         |         4.38 usec     |
| `n=2**10`      |         26.3 usec         |         4.38 usec     |
| `n=2**11`      |         51.4 usec         |         4.35 usec     |
| `n=2**12`      |          121 usec         |         4.92 usec     |
| `n=2**13`      |          326 usec         |         7.01 usec     |
| `n=2**14`      |          590 usec         |         5.58 usec     |
| `n=2**15`      |         1.06 usec         |         7.27 usec     |
| `n=2**16`      |         2.72 usec         |         6.06 usec     |
| `n=2**17`      |         6.23 usec         |         8.55 usec     | 
| `n=2**18`      |         6.57 usec         |         9.84 usec     |
| `n=2**19`      |         13.2 usec         |         8.31 usec     |
| `n=2**20`      |         32.5 usec         |         7.91 usec     |
| `n=2**21`      |         70.9 usec         |         9.91 usec     |
| `n=2**22`      |          129 usec         |         8.73 use      |
...
| -------------------------- | ---------| --------|------------ | ------------- |
| `sequential_search_itr`    | 21.3         |  2.86       |   3.29          |       3.73        |
| `sequential_search_itr2`   | 2.83         | 6.59        |    6.01         |   185            |
| `sequential_search_rec`    |  ---     | ---     |  ---        |  ---          |
| `binary_search_itr`        | 28.5         | 5.79        | 6.02        |     243          |
| `binary_search_rec`        | 32.3         |  9       |       11.6      |   307            |
| `binary_search_rec2`       | 16.8         |  729       |     746        |  ---          |
